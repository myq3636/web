...
import com.jx.tennis.common.exception.user.UserPasswordNotMatchException;
import com.jx.tennis.common.exception.user.UserPasswordRetryLimitExceedException;
...
import com.jx.tennis.util.MessageUtils;
...
public class PasswordService
{
    ...
    {
       //user.getPassword().equals(encryptPassword(user.getLoginName(), newPassword, user.getSalt()));
